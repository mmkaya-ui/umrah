...
export const SaiPage = {
    ...
    <div class="page-container">
      ...
      <main style="padding-top: var(--spacing-4);">
        <div class="card" style="text-align: center;">
          <h2 class="text-gold font-semibold" style="margin-bottom: var(--spacing-2);" data-i18n="sai.title"></h2>
          ...
          <div id="sai-direction" class="badge" style="margin-bottom: var(--spacing-3); display: inline-block;">
            Safa -> Merve
          </div>
          ...
          <div id="sai-complete-msg" class="text-green font-semibold" style="display: none; margin-top: var(--spacing-4);" data-i18n="tawaf.complete"></div>
        </div>
      </main>
    </div>
    `;
  ...
  afterRender: () => {
    ...
    const updateUI = () => {
      ...
      if (currentCount % 2 === 0) {
        directionDisplay.textContent = 'Safa ➔ Merve';
        directionDisplay.style.backgroundColor = 'rgba(212, 175, 55, 0.1)';
      } else {
        directionDisplay.textContent = 'Merve ➔ Safa';
      ...
      if (currentCount >= 7) {
        ...
        directionDisplay.textContent = 'Bitti / Completed';
      } else {
